package com.bingglewcloud.bingglew.auth.endpoint;
...
public class BingglewTokenEndpoint {
	...
	public R tokenList(@RequestBody Map<String, Object> params, @RequestHeader(required = false) String from) {
		...
		for (String page : pages) {
			...
			if (authentication instanceof UsernamePasswordAuthenticationToken) {
				...
				if (authenticationToken.getPrincipal() instanceof BingglewUser) {
					BingglewUser user = (BingglewUser) authenticationToken.getPrincipal();
