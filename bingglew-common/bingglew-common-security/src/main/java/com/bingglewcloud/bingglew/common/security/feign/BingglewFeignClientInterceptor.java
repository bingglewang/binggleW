 ...
 */
@Slf4j
public class BingglewFeignClientInterceptor extends OAuth2FeignRequestInterceptor {
	 ...
	 */
	public BingglewFeignClientInterceptor(OAuth2ClientContext oAuth2ClientContext
